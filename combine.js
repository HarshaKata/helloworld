...
async function getCombinedMessage() {
    try {
        const helloResponse = await axios.get('http://localhost:3002/hello'); /* alternatively 'http://127.0.0.1:53665/hello' can also be used - this url is returned when 'minikube service hello' is executed */
